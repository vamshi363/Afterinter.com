...
// We could export Metadata here if this was a Server Component, 
// but since we need useState, we can use a wrapper or just rely on layout metadata.
// For best SEO, this page should ideally be Server Component with SearchParams prop,
// but for preserving the "interactive" filter UI exactly as is, we use 'use client'.
