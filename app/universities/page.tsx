      ...
      <AnimatePresence>
        {showFilterSheet && (
          <>
            ...
            <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }} className="fixed inset-x-0 bottom-0 bg-white dark:bg-slate-900 rounded-t-[2rem] z-50 flex flex-col shadow-2xl overflow-hidden max-h-[85vh]">
